...
/**
 * The blue ghost that go randomly.
 */
@Data
@EqualsAndHashCode(callSuper = false)
public class Inky extends ACellObject{
     ...
     */
    public Inky(String imageIcon, int score, String type, double locationX, double locationY, double vel, IUpdateStrategy updateStrategy) {
